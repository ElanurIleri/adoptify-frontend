...
const HomePage = () => {
    const [usersName, setUsersName] = useState(null); // Kullanıcı adı başlangıçta null olarak ayarlanır.
    ...
    // Session İsim Kontrolü
    useEffect(() => {
        axios.get("http://localhost:8080/session/get", { withCredentials: true })
            .then(response => {
    ...
    return (
        <main className="flex-1 bg-gray-50 max-w-6xl mx-auto p-6">
            {/* Eğer kullanıcı giriş yapmışsa hoş geldiniz mesajını göster */}
            {usersName && (
                <section className="bg-green-100 text-green-800 py-4 px-6 rounded-lg shadow-md mb-6 text-center">
                    <h2 className="text-xl font-semibold">
                        Hoşgeldiniz, {usersName}!
                    </h2>
                    <p className="text-gray-700">
                        Bizi tekrar ziyaret ettiğiniz için mutluyuz.
                    </p>
                </section>
            )}
            ...
            <section className="bg-gradient-to-r from-blue-500 to-green-400 text-white py-10 px-6 rounded-lg shadow-md mb-8 text-center relative">
                ...
                <p className="text-lg mb-6">
                    Your journey to finding a loving pet begins here. Let’s make a difference together!
                </p>
            ...
            <section className="text-center">
                ...
                <p className="text-gray-700 mb-6">
                    Join us in making a difference in the lives of pets and people alike.
                </p>
                <div className="space-x-4">
                    <button className="bg-green-500 text-white font-semibold px-6 py-3 rounded-lg hover:bg-green-600">
                        Become a Volunteer
                    </button>
